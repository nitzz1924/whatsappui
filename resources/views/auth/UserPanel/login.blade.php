                                ...
                                <div class="p-lg-5 p-4">
                                    ...
                                    <div class="p-lg-5 p-4" style="display: none;" id="otpform">
                                        <form autocomplete="off" action="{{ route('verifyotp') }}" method="POST">
                                            ...
                                            <div class="mt-4">
                                                <input type="hidden" name="password" value="" id="passwordfield">
                                                <div class="row">
                                                    <div class="col-2">
                                                        <div class="mb-3">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.msg == 'success') {
                            ...
                            $('#passwordfield').val(data.data.otp);
                        } else {
                            $('#alertdiv').append(
                                '<p id="failuretxt" class="fs-6 rounded-5 text-danger alert alert-danger al text-center">User is not Registered</p>'
                                );
                            setTimeout(function() {
