                            ...
                            <div class="p-4  h-100">
                                <div class="p-3 rounded-5 m-3 border-0 card auth-one-bg">
                                    <div class="p-3 mt-3">
                                        ...
                                        <p class="text-white">Reach your audience instantly and effectively with
                                            targeted WhatsApp campaigns by YUVMEDIA.</p>
                                    </div>
                                    <hr class="text-white">
                                    <div class="p-3 m-3">
                                    ...
                                    <form action="{{ route('signup_user_otp') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <span id="togglePassword" class="position-absolute"
                                                style="right: 61px; top: 53%; transform: translateY(-50%); cursor: pointer;">
                                                <i id="eyeIcon" class="ri-eye-off-line fs-4"></i>
                                            </span>
                                        </div>
                                        <div id="alertdiv">
