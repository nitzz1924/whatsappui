                                            ...
                                            <div class="chat-message-list">
                                                <ul class="list-unstyled chat-list chat-user-list" id="contactlist">
                                                    ...
                                                    <li id="contact-id-{{ $data->id }}" data-name="{{ strtolower($data->contactname) }}" class="{{ $data->is_active ? 'active' : '' }}">
                                                        ...
                                                        @endphp
                                                        <a href="#" onclick="contactReturn();" class="contact-tab" data-value="{{ json_encode($data) }}">
                ...
                <div class="w-100 overflow-hidden position-relative" style="height:87vh;">
                    ...
                    <div class="position-relative" id="chatrow" style="display: none;">
                        ...
                        <div class="chat-input-section p-3 p-lg-4 d-none" id="chatinputsection">
                            <form action="{{ route('replyamessage')}}" method="POST">
                                @csrf
                                <div class="row g-0 align-items-center">
                                    <div class="col">
...
<script>
    ...
    function contactInfo() {
        $('.contact-tab').on('click', function() {
            ...
            console.log("contact offcanvas",contacttab);
        ...
        dataValue.forEach((element) => {
            ...
            if (element.format === 'IMAGE' || element.format === 'VIDEO') {
                ...
                <div class="mb-3">
                    ...
                    <button type="button" data-bs-toggle="modal" data-bs-target="#mediamodal" class="btn  btn-sm text-white rounded-4"       style="background-color: #116464;">
                        Choose Media
                    </button>
            `;
