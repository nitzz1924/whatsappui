                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-around">
                                        <div class="overflow-hidden">
                                            <img src="{{asset('assets/images/send.png')}}" alt="" height="30"
                                                width="30">
                                        </div>
                                        <div class="overflow-hidden">
                                        ...
                                        <div class="float-end">
                                            <h4 class="mt-1">
                                                <span class="counter-value"
                                                    data-target="{{$sentmsgcount}}">{{$sentmsgcount}}</span>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-2 col-md-6">
                            <div class="card card-animate rounded-4 py-0" style="border-bottom: 4px solid #054c44;">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-around">
                                        <div class="overflow-hidden">
                                            <img src="{{asset('assets/images/receive.png')}}" alt="" height="30"
                                                width="30">
                                        </div>
                                        <div class="overflow-hidden">
                                            <p class="text-uppercase fw-medium text-muted text-truncate mb-0">
                                        ...
                                        <div class="float-end">
                                            <h4 class="mt-1">
                                                <span class="counter-value"
                                                    data-target="{{$recmsgcount}}">{{$recmsgcount}}</span>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-2 col-md-6">
                            <div class="card card-animate rounded-4 py-0" style="border-bottom: 4px solid #054c44;">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-around">
                                        <div class="overflow-hidden">
                                            <img src="{{asset('assets/images/id-card.png')}}" alt="" height="30"
                                                width="30">
                                        </div>
                                        <div class="overflow-hidden">
                                            <p class="text-uppercase fw-medium text-muted text-truncate mb-0">
                                        ...
                                        <div class="float-end">
                                            <h4 class="mt-1">
                                                <span class="counter-value"
                                                    data-target="{{$contactscount}}">{{$contactscount}}</span>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-2 col-md-6">
                            <div class="card card-animate rounded-4 py-0" style="border-bottom: 4px solid #054c44;">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-around">
                                        <div class="overflow-hidden">
                                            <img src="{{asset('assets/images/newsletter.png')}}" alt="" height="30"
                                                width="30">
                                        </div>
                                        <div class="overflow-hidden">
                                            <p class="text-uppercase fw-medium text-muted text-truncate mb-0">
                                        ...
                                        <div class="float-end">
                                            <h4 class="mt-1">
                                                <span class="counter-value"
                                                    data-target="{{$tempcount}}">{{$tempcount}}</span>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-2 col-md-6">
                            <div class="card card-animate rounded-4 py-0" style="border-bottom: 4px solid #054c44;">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-around">
                                        <div class="overflow-hidden">
                                            <img src="{{asset('assets/images/campaign.png')}}" alt="" height="30"
                                                width="30">
                                        </div>
                                        <div class="overflow-hidden">
                                            <p class="text-uppercase fw-medium text-muted text-truncate mb-0">
                                        ...
                                        <div class="float-end">
                                            <h4 class="mt-1">
                                                <span class="counter-value"
                                                    data-target="{{$campaignscnt}}">{{$campaignscnt}}</span>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
